...
cartsRouter.put("/:productId", passportCall(['jwt', 'github']), (req, res) => cartController.updateCart(req, res));

cartsRouter.delete('/errase/:productId', passportCall(['jwt', 'github']), (req, res) => cartController.removeFromCart(req, res));
